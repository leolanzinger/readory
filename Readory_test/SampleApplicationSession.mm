...
namespace {
    ...
    NSString * SAMPLE_APPLICATION_ERROR_DOMAIN = @"readory";
}
...
- (void)initQCARInBackground
{
    ...
    @autoreleasepool {
        QCAR::setInitParameters(mQCARInitFlags,"");
